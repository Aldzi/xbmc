...
>>>>>>> 3a848a8... Implementation of optional function to handle analogue output on Raspberry Pi as it was in XBMC Frodo and before. After Frodo, amplifier wasn't used anymore
CSettings::CSettings()
  : m_initialized(false)
{
...
void CSettings::InitializeISettingCallbacks()
{
  ...
  settingSet.insert("audiooutput.useanalogamplifier");
